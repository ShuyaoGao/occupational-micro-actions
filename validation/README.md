...
| File | Content |
|---|---|
| `annotation_guide_zh.md` | The guide given to annotators (Chinese; annotators worked blind to model labels and study hypotheses) |
| `sampleA_fidelity_annotations_bilingual.csv` | 79-DWA fidelity audit, 3 annotators × 79 items (237 rows); ratings Q1 completeness / Q2 faithfulness / Q3 granularity (1–5); 102 free-text notes in original Chinese (`notes_zh`, authoritative) with English translations by the authors (`notes_en`) |
...
| `build_bilingual_release.py` | Builds the two release CSVs from the returned annotation spreadsheets (includes the full zh→en note translations) |
